...
let DepartmentController = class DepartmentController {
    ...
    async getSupervisors(departmentId) {
...
], DepartmentController.prototype, "getAllCompanies", null);
__decorate([
    (0, common_1.Get)('department'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Body)('departmentId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], DepartmentController.prototype, "getSupervisors", null);
__decorate([
    (0, common_1.Post)('create-department'),
    (0, common_1.HttpCode)(common_1.HttpStatus.CREATED),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [department_dto_1.CreateDto]),
    __metadata("design:returntype", Promise)
], DepartmentController.prototype, "createDepartment", null);
__decorate([
    (0, common_1.Patch)('update-department'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
...
__decorate([
    (0, common_1.Delete)('delete-department'),
