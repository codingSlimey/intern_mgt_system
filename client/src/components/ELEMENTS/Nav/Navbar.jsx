  ...
  return (
    <nav className={styles.nav}>
        ...
        <div className={styles.cont}>
          ...
          />
          <div>
            <HeaderTwo text={'Ahmed Ibrahim'} color={'#003976'} fontSize={'16px'} margin={'0 0 0.3rem 0'} fontWeight={'500'} />
            <Paragraph text={t('nav.stu')} fontSize={'12px'} color={'#003976'} margin={'0 0 0 0'} fontWeight={'700'} />
          </div>
        </div>
